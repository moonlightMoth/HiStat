...
public class AbnormalVals {
    ...
    private HashMap<Regression, List<Integer>> xAnomaly = new HashMap<>();
    private HashMap<Regression, List<Integer>> yAnomaly = new HashMap<>();
    ...
    public void checkSingleXYRegression(Regression regression, BasicStat basicStat, int x, int y)
    {
//        int n = basicStat.getNumOfVars();
//        int m = basicStat.getNumOfMeasurements();
//        int pow = regression.getPower();
//        double avg = (regression.getPower() + 1)/ (double) n;
...
//                List<Integer> anoms = xAnomaly.getOrDefault(regression, new ArrayList<>());
//                anoms.add(i);
//                xAnomaly.put(regression, anoms);
//            }
//        }
//
//        double[][] sampling = basicStat.getSampling();
//        double[] coefs = regression.getCoefficients();
...
//                List<Integer> anoms = yAnomaly.getOrDefault(regression, new ArrayList<>());
//                anoms.add(i);
//                yAnomaly.put(regression, anoms);
//            }
//        }
    }

    public HashMap<Regression, List<Integer>> getxAnomaly()
    {
        return xAnomaly;
    }

    public HashMap<Regression, List<Integer>> getyAnomaly()
    {
        return yAnomaly;
    }
}
